  ...
  <div class="app-container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top main-navbar">
      <div class="container px-3 px-md-5">
        ...
        <div id="navbarNav" class="collapse navbar-collapse justify-content-end" :class="{ 'show': isNavOpen }">
        ...
        <div class="row py-5 g-4">
          ...
          <div class="col-md-4">
            ...
            <address class="footer-address">
              ...
              <abbr title="Telefone">Tel:</abbr> <a href="tel:+5531992246996" class="text-decoration-none text-reset" aria-label="Ligar para Cardoso & Bruno: (31) 9.9224-6996">(31) 9.9224-6996</a>
            </address>
          </div>
        </div>
