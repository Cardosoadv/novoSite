  ...
  <div class="app-container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top main-navbar">
      <div class="container px-3 px-md-5">
        ...
        <div class="collapse navbar-collapse justify-content-end" :class="{ 'show': isNavOpen }" id="main-navbar-nav">
        ...
        <div class="row py-5 g-4">
          ...
          <div class="col-md-4">
            ...
            <address class="footer-address">
              ...
              <abbr title="Telefone">Tel:</abbr> <a href="tel:31992246996" class="text-decoration-none text-reset">(31) 9.9224-6996</a>
            </address>
          </div>
        </div>
