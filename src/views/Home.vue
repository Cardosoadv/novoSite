        ...
        <div class="row g-5">
            ...
            <div class="contact-methods mt-5">
              ...
              <div class="contact-item d-flex gap-3 mb-4">
                ...
                <div>
                  ...
                  <p class="contact-value">
                    <a href="tel:+5531992246996" class="contact-link">(31) 9.9224-6996</a>
                  </p>
                </div>
              </div>
              <div class="contact-item d-flex gap-3">
                ...
                <div>
                  ...
                  <p class="contact-value">
                    <a href="mailto:contato@cardosoebruno.adv.br" class="contact-link">contato@cardosoebruno.adv.br</a>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-7">
            <div class="contact-form-container">
              <div v-if="submitSuccess" class="success-card text-center p-5 animate-fade-in" aria-live="polite">
